...
{
	"You just got rekt by GodLike",
	"Get Good! Get GodLike!",
	"I'm not cheating, but If I was I would recommend GodLike",
	"GodLike > all",
	"Never fear vac with GodLike Private",
	"Stop being a noob nigger, get GodLike"
};
